    ...
    */
    ...
    var self=function(radius, imagesList, width, height) {
        ...
        for (var i=0; i<l; i++)
        {
            ...
            this.images[i].image.onload=function(i){ return function(){buildCarousel2(scope, i);} }(i);
    ...
    function buildCarousel2(scope, i) 
    {
        ...
        */
        canvas = document.createElement( 'canvas1' );
        canvas.width = w;
    ...
    /////////////////NOT USED//////////////////
    // <private> build the carousel when everything is loaded
    function buildCarouselPrev2(scope) {
