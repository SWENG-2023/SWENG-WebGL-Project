...
SnakeGame.prototype._createALight = function (pos, color, n, f, intensity) {
    var light = new Light();
...
SnakeGame.prototype._initializeLights = function () {
...
SnakeGame.prototype._moveSnakeLight = function (snakeHead) {
...
SnakeGame.prototype._moveAppleLight = function (apple) {
